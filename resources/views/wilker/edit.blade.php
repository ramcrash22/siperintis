<form action="/wilker/{{$wilker->kodewilker}}/update" method="POST" id="frmWilker" autocomplete="off">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" readonly id="kodewilker" value="{{$wilker->kodewilker}}" class="form-control" name="kodewilker" placeholder="Kode Wilayah Kerja">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="namawilker" value="{{$wilker->namawilker}}" class="form-control" name="namawilker" placeholder="Nama Wilayah Kerja / Pos">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="lokasikantor" value="{{$wilker->lokasikantor}}" class="form-control" name="lokasikantor" placeholder="Lokasi Kantor">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="radius" value="{{$wilker->radius}}" class="form-control" name="radius" placeholder="Radius Presensi">
            </div>
        </div>
    </div>
    <div class="row">
